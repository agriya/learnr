...
UPDATE "settings" SET "value" = 'VideoLessons, CourseCheckout, SocialLogins, RatingAndReview, UserProfile, Comments, SEO, PayPal' WHERE name = 'site.enabled_plugins';

UPDATE "settings" SET "value" = 'Learnr' WHERE "name" = 'site.name';
