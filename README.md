...
Learnr is an open source online training platform similar to Udacity Clone script to make websites concerning online training marketplaces. It is written in AngularJS with REST API for high performance in mind.
...
Learnr is an open source online training project. Full commercial support (commercial license, customization, training, etc) are available through [Learnr platform](http://learnr.demo.agriya.com/#!/)
